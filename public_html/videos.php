...
<body>
	<nav>
		<ul class="menu_list">
			...
			<li class="list_item"><div id="menu"><img src="images/videos.png"></div><a href="videos.html" class="link">Videos</a></li>
	...
	<div id="pub">
					<div id="usuario">
						<a href="#">
							...
							<div id="nombre"><span>Damian Briseño</span></div>
							<div id="usuario1"><p>@el_mariscos</p></div>
						</a>
					</div>
					<div id="publicacion">
						<div id="texto"><span>gg
						</span>
						<div id="video"><video width="520" height="300" controls><source src="videos/video1.mp4" type="video/mp4"></video>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="pub">
					...
					<div id="publicacion">
						...
						<div id="video"><video width="520" height="300" controls><source src="videos/video.mp4" type="video/mp4"></video>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="pub">
					...
					<div id="publicacion">
						...
						<div id="video"><video width="520" height="300" controls><source src="videos/video2.mp4" type="video/mp4"></video>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="pub">
					...
					<div id="publicacion">
						...
						<div id="video"><video width="520" height="300" controls><source src="videos/video3.mp4" type="video/mp4"></video>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="pub">
					...
					<div id="publicacion">
						...
						<div id="video"><video width="520" height="300" controls><source src="videos/video4.mp4" type="video/mp4"></video>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="contenido">
		<article>
			...
			<div class="item">
				...
				<div id="tendencias">
					<div id="photo"><img src="images/play.png"></div>
